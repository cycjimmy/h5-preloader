(function (global, factory) {
	...
	(global = global || self, global.h5Preloader = factory());
	...
	***************************************************************************** */
	...
	function () {
	  ...
	  _proto.setHooks = function setHooks(_temp) {
	    var _ref = _temp === void 0 ? {} : _temp,
	...
	function () {
	  ...
	  function _default$1(_temp) {
	    ...
	    this.resLoader = new _default().setResources(resources).setHooks({
	...
	var index = (function (param) {
	  ...
	  var h5Preloader = new _default$1(param);
